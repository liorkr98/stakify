    ...
    <div className="bg-card border border-border/60 rounded-xl overflow-hidden">
      ...
      <div className="divide-y divide-border/30">
        {MOCK_ANALYSTS.map((analyst, index) => (
          <div key={analyst.id} className="px-5 py-3 flex items-center gap-3 hover:bg-secondary/50 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-foreground truncate">{analyst.name}</p>
